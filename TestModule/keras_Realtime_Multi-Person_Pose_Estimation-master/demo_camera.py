...
if __name__ == '__main__':
    ...
    # Video reader
    cam = cv2.VideoCapture("../../TestPython/data/pull_up.mp4")
    ...
    while True:
        ...
        canvas_test = draw(numpy_tmp, all_peaks, subset, candidate, resize_fac=resize_fac)
        ...
        print(type(canvas_test), canvas_test.shape, type(canvas), canvas.shape)

        cv2.imshow('frame_origin', canvas)
        cv2.imshow('frame_only_skeleton', canvas_test)
